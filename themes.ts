...
export const PREDEFINED_THEMES: Theme[] = [
    ...
    },
    {
        ...
        colors: {
            background: "#0d0221",
            displayBackground: "rgba(10, 5, 30, 0.7)",
            textPrimary: "#00f6ff",
            textSecondary: "#8a2be2",
            accent: "#ff00c1",
            accentHover: "#ff3dd8",
            buttonBackground: "#261a45",
            buttonBackgroundHover: "#3a2a63",
            buttonOperatorBackground: "#261a45",
            buttonOperatorBackgroundHover: "#3a2a63",
            buttonAdvancedBackground: "#261a45",
            buttonAdvancedBackgroundHover: "#3a2a63",
            buttonSpecial1Background: "#261a45",
            buttonSpecial1BackgroundHover: "#3a2a63",
            buttonSpecial2Background: "#ff00c1",
            buttonSpecial2BackgroundHover: "#ff3dd8",
        }
    },
    {
        name: "Future 20000",
        colors: {
            background: "#f0f4ff",
            displayBackground: "rgba(210, 220, 255, 0.5)",
            textPrimary: "#2a3b6e",
            textSecondary: "#8a9ac4",
            accent: "#ff8c6f",
            accentHover: "#ffa28c",
            buttonBackground: "rgba(255, 255, 255, 0.7)",
            buttonBackgroundHover: "#e2e8f5",
            buttonOperatorBackground: "rgba(255, 200, 180, 0.6)",
            buttonOperatorBackgroundHover: "rgba(255, 170, 140, 0.8)",
            buttonAdvancedBackground: "rgba(226, 232, 245, 0.8)",
            buttonAdvancedBackgroundHover: "#d8e0f0",
            buttonSpecial1Background: "rgba(255, 180, 180, 0.7)",
            buttonSpecial1BackgroundHover: "rgba(255, 150, 150, 0.9)",
            buttonSpecial2Background: "#ff8c6f",
            buttonSpecial2BackgroundHover: "#ffa28c",
        }
    },
    {
        name: "Future 50000",
        colors: {
            background: "#020024",
            displayBackground: "rgba(10, 5, 30, 0.75)",
            textPrimary: "#00f6ff",
            textSecondary: "#8a2be2",
            accent: "#ff00c1",
            accentHover: "#ff3dd8",
